...
function Bio() {
  ...
  return (
    <div data-aos='fade-right' className='flex md:flex-row flex-col justify-center items-center mx-6 px-0 p-4 md:p-8 bg-teal-700 rounded-lg shadow-md shadow-slate-400'>
      <div className='flex justify-center items-center w-3/5'>
        <h3 className=' text-slate-200 md:text-2xl text-xl font-burtons'>

...
function AboutMe() {
  return (
    <div className='h-full w-full lg:w-1/2 flex flex-col gap-6 p-7 pt-12 lg:mb-0 mb-3 items-center rounded-lg bg-gradient-to-b from-green-100 to-green-50 shadow-md shadow-slate-400'>

...
function About() {
  return (
        <div className=' h-full w-full lg:w-1/2 flex flex-col justify-center gap-3 md:p-7 py-7 text-center rounded-lg bg-gradient-to-b from-green-100 to-green-50 shadow-md shadow-slate-400'>
